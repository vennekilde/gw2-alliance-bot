...
func (c GuildWars2VerificationAPI) doReqWithBody(method, urlStr string, data interface{}, headers, queryParams map[string]interface{}) (*http.Response, error) {
...
func (c GuildWars2VerificationAPI) doReqNoBody(method, urlStr string, headers, queryParams map[string]interface{}) (*http.Response, error) {
	return c.doReq(method, urlStr, nil, headers, queryParams)
}

func (c GuildWars2VerificationAPI) doReq(method, urlStr string, body io.Reader, headers, queryParams map[string]interface{}) (*http.Response, error) {
	// create the request
	...
	if c.AuthHeader != "" {
		req.Header.Set("X-Access-Token", c.AuthHeader)
	}
